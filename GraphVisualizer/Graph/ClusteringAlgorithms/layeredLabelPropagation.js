...
let jLayeredLabelPropagation = function (nds, edgs, gamma, steps_input) { // A function expression can be stored in a variable. After it has been
...
export default jLayeredLabelPropagation;